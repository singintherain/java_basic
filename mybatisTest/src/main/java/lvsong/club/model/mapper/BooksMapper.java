...
public interface BooksMapper {
    ...
    @Insert({
        ...
        "author_id)",
        "values (#{authorName,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP,typeHandler=lvsong.club.typeHandler.JodaDateTime2TimestampTypeHandler}, ",
    ...
    @Update({
        ...
        "set author_name = #{authorName,jdbcType=VARCHAR},",
          "create_time = #{createTime,jdbcType=TIMESTAMP,typeHandler=lvsong.club.typeHandler.JodaDateTime2TimestampTypeHandler},",
